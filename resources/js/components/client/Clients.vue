         ...
         <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <router-link to="/clients" class="card-body">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <router-link to="/clients/create" class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-danger shadow h-100 py-2">
                                <router-link to="/clients/debts" class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{infos.clientsWithDebts}}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <router-link to="/clients/deleted" class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
...
export default {
    ...
    methods: {
        getInfos(){
            axios.get('/api/clients/infos').then(resp=>{
                console.log(resp)
